// Package reporting Code generated by swaggo/swag. DO NOT EDIT
package reporting

import "github.com/swaggo/swag"

const docTemplatereporting = `{
    ...
    "paths": {
        ...
        "/contact-persons": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Contact Person request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/meta/brands/{brand_id}/campaigns": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/meta/brands/{brand_id}/campaigns/summary": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
    ...
    "definitions": {
        "dto.ActivityResponse": {
            ...
            "properties": {
                ...
                "brand": {
                    "$ref": "#/definitions/internal_meta_activity_dto.SimpleBrand"
                },
                "created_at": {
                    "type": "string"
                },
        ...
        "dto.FraudLogResponse": {
            ...
            "properties": {
                ...
                "ad": {
                    "$ref": "#/definitions/dto.SimpleAd"
                },
                "ad_account": {
                    "$ref": "#/definitions/dto.SimpleAdAccount"
                },
                "adset": {
                    "$ref": "#/definitions/dto.SimpleAdSet"
                },
                "brand": {
                    "$ref": "#/definitions/internal_core_fraud_log_dto.SimpleBrand"
                },
                "campaign": {
                    "$ref": "#/definitions/dto.SimpleCampaign"
                },
                "created_at": {
                    "type": "string"
                },
        ...
        "internal_core_fraud_log_dto.SimpleBrand": {
            "type": "object",
            "properties": {
                "id": {
                    "type": "integer"
        ...
        "internal_meta_activity_dto.SimpleBrand": {
            "type": "object",
            "properties": {
                "id": {
                    "type": "integer"
...
// SwaggerInforeporting holds exported Swagger Info so clients can modify it
var SwaggerInforeporting = &swag.Spec{
	Version:          "1.0",
	Host:             "localhost:8888",
	BasePath:         "/api/v1",
	Schemes:          []string{},
	Title:            "Reporting API",
	Description:      "Reporting Domain API",
	InfoInstanceName: "reporting",
	SwaggerTemplate:  docTemplatereporting,
	LeftDelim:        "{{",
	RightDelim:       "}}",
}

func init() {
	swag.Register(SwaggerInforeporting.InstanceName(), SwaggerInforeporting)
}
